...
// .violin-assembly no longer exists (it was the old hand-drawn SVG's
// group, replaced by the 3D canvas) — removed that dead GSAP call.
// .string-label's fade-in also moved to pure CSS (see styles.css,
// labelEntrance keyframes) instead of GSAP, since relying on GSAP
// here for a simple entrance was fragile and could leave the labels
// stuck at opacity:0 if anything upstream in the timeline warned/failed.
